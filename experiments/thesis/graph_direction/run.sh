...
python3 -u search_hyperparams.py --parameter_space experiments/thesis/graph_direction/params.json --learning_task premise --experiment_dir experiments/thesis/graph_direction/premise --graph_bidirectional
...
python3 -u search_hyperparams.py --parameter_space experiments/thesis/graph_direction/params.json --learning_task similarity --experiment_dir experiments/thesis/graph_direction/similarityn --graph_bidirectional
